...
class Config():
    def __init__(self):
        ...
        self.SQLALCHEMY_DATABASE_URL = os.getenv("DATABASE_URL", "postgresql://default:Qshx82gMEYNJ@ep-young-hill-a2xr36fw-pooler.eu-central-1.aws.neon.tech:5432/verceldb?sslmode=require") # Change tou your db
