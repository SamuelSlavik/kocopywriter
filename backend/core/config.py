...
class Config():
    def __init__(self):
        ...
        self.SQLALCHEMY_DATABASE_URL = os.getenv("DATABASE_URL", "postgres://default:Qshx82gMEYNJ@ep-young-hill-a2xr36fw.eu-central-1.aws.neon.tech:5432/verceldb") # Change tou your db
